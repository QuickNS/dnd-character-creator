...
def test_species_selection_integration(client):
    ...
    with app.test_client() as client:
        ...
        # Choose class
        print("\n2. Selecting class...")
        response = client.post('/select-class', data={
            'class': 'Ranger'
        }, follow_redirects=False)
        ...
        response = client.post('/select-background', data={
            'background': 'Sage'
        }, follow_redirects=False)
        ...
        response = client.post('/select-species', data={
            'species': 'Elf'
        }, follow_redirects=False)
        ...
        response = client.post('/select-lineage', data={
            'lineage': 'Wood Elf',
