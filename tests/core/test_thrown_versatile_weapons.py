...
class TestThrownAndVersatileWeapons:
    ...
    def test_thrown_weapon_shows_throw_damage(self, fighter_with_thrown_weapon_fighting):
        ...
        assert spear["throw_damage"] == "1d6 + 5", "Throw damage should be 1d6 + 5 (STR +3, TWF +2)"
    ...
    def test_spear_shows_all_three_damage_types(self, fighter_with_thrown_weapon_fighting):
