...
class TestEffectTypes:
    ...
    def test_damage_resistance_effect(self, tiefling_paladin):
        ...
        resistance_effects = [e for e in json_data['effects'] 
        ...
        new_resistance_effects = [e for e in new_json['effects'] 
                                 if e.get('type') == 'grant_damage_resistance']
    ...
    def test_grant_spell_effects(self, tiefling_paladin):
        ...
        spell_effects = [e for e in json_data['effects'] 
        ...
        new_spell_effects = [e for e in new_json['effects'] 
                           if e.get('type') == 'grant_spell']
