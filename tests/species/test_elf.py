...
class TestElfSpecies:
    ...
    def test_keen_senses_skill_proficiency_choice(self):
        ...
        for chosen_skill in skill_choices:
            ...
            initial_skills = builder.character_data['proficiencies']['skills'].copy()
            ...
            assert chosen_skill in skill_proficiencies, f"Should have proficiency in {chosen_skill}"
...
class TestElfLineages:
    ...
    def test_lineage_spells_by_level(self):
        ...
        applied_effects = getattr(builder, 'applied_effects', [])
        spell_effects = [e for e in applied_effects if e['effect']['type'] in ['grant_cantrip', 'grant_spell']]
...
class TestElfDataValidation:
    ...
    def test_elf_lineage_data_files(self):
        ...
        for lineage_file in lineages:
            ...
            spell_traits = [trait for trait in traits.values() if isinstance(trait, dict) and 'effects' in trait]
            assert len(spell_traits) >= 1, f"{lineage_file} should have spell-granting traits"
