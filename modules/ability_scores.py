...
class AbilityScores:
    ...
    def __init__(self):
        ...
        self.species_bonuses: Dict[str, int] = {ability: 0 for ability in self.ABILITIES}
        self.background_bonuses: Dict[str, int] = {ability: 0 for ability in self.ABILITIES}
    ...
    def print_ability_breakdown(self, character_name: str = "Character"):
        ...
        print(f"{'Ability':<12} {'Base':<4} {'Species':<7} {'Background':<10} {'Final':<5} {'Modifier':<8}")
        print("-" * 55)
        ...
        for ability in self.ABILITIES:
            ...
            print(f"{ability:<12} {base:<4} +{species:<6} +{background:<9} {final:<5} {mod_str:<8}")
