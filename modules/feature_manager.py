...
class FeatureManager:
    ...
    def parse_trait_features(self, trait_name: str, trait_data: Any, source: str) -> List[Dict[str, Any]]:
    ...
    def _parse_string_trait(self, trait_name: str, description: str, source: str) -> List[Dict[str, Any]]:
    ...
    def _parse_dict_trait(self, trait_name: str, trait_data: dict, source: str) -> List[Dict[str, Any]]:
    ...
    def _matches_pattern(self, trait_name: str, description: str, pattern_data: dict) -> bool:
    ...
    def _create_feature_from_pattern(self, trait_name: str, description: str, 
                                   source: str, pattern_data: dict) -> Dict[str, Any]:
    ...
    def apply_feature(self, feature: Dict[str, Any], feature_bonuses: Dict[str, List[Dict[str, Any]]]):
    ...
    def get_feature_summary(self, active_features: List[Dict[str, Any]]) -> Dict[str, List[str]]:
    ...
    def get_features_by_source(self, source: str) -> Dict[str, Dict[str, Any]]:
        ...
        return {name: data for name, data in self.feature_registry.items() 
