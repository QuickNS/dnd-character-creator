...
class EquipmentManager:
    ...
    def add_item(
        self,
        character_equipment: Dict[str, Any],
        item_name: str,
        category: str,
        quantity: int = 1,
    ) -> None:
        ...
        character_equipment[category].append(
            {"name": item_name, "quantity": quantity, "properties": item_data}
        )
    ...
    def get_all_armor(
        self, character_equipment: Dict[str, Any]
    ) -> List[Dict[str, Any]]:
    ...
    def can_use_weapon(self, weapon_name: str, proficiencies: List[str]) -> bool:
        ...
        for prof in proficiencies:
            ...
            if (
                prof_lower == prof_required.lower()
                or prof_lower == weapon_name.lower()
                or prof_lower == "all weapons"
            ):
                return True
