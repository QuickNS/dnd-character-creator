...
### 2. **`docs/PDF_QUICK_START.md`**
   - **Updated**: HTML character sheet route example to use `builder.to_character()` instead of manual calculation assembly
...
├── PDF_QUICK_START.md          # HTML character sheet guide (UPDATED)
