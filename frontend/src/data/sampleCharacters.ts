...
export const SAMPLE_CHARACTERS: SampleCharacter[] = [
  {
    ...
    choices: {
      ...
      classes: [{ class_name: "Barbarian", level: 3, subclass: "Path of the Berserker" }],
      class: "Barbarian",
      level: 3,
      subclass: "Path of the Berserker",
      species: "Goliath",
      ...
      ability_scores: { Strength: 15, Dexterity: 13, Constitution: 14, Intelligence: 8, Wisdom: 12, Charisma: 10 },
      background_bonuses: { Strength: 2, Constitution: 1 },
      skill_choices: ["Athletics", "Intimidation"],
      languages: ["Giant", "Orc"],
      equipment_selections: { class_equipment: "option_a", background_equipment: "option_a" },
    },
  },
  {
    id: "bard",
    ...
    choices: {
      ...
      classes: [{ class_name: "Bard", level: 3, subclass: "College of Valor" }],
      class: "Bard",
      level: 3,
      subclass: "College of Valor",
      species: "Tiefling",
      ...
      ability_scores_method: "standard_array",
      ability_scores: { Strength: 10, Dexterity: 14, Constitution: 13, Intelligence: 8, Wisdom: 12, Charisma: 15 },
      ...
      spell_selections: {
        ...
        spells: ["Dissonant Whispers", "Cure Wounds", "Charm Person", "Thunderwave", "Aid", "Enhance Ability"],
        background_cantrips: [],
        background_spells: [],
      },
  ...
  },
  {
    ...
    choices: {
      ...
      classes: [{ class_name: "Cleric", level: 3, subclass: "War Domain" }],
      class: "Cleric",
      level: 3,
      subclass: "War Domain",
      species: "Dwarf",
      ...
      ability_scores_method: "standard_array",
      ability_scores: { Strength: 13, Dexterity: 10, Constitution: 14, Intelligence: 8, Wisdom: 15, Charisma: 12 },
      background_bonuses: { Wisdom: 2, Constitution: 1 },
      skill_choices: ["History", "Religion"],
      spell_selections: {
        cantrips: ["Toll the Dead", "Word of Radiance", "Guidance"],
        spells: ["Bless", "Healing Word", "Detect Magic", "Hold Person", "Aid", "Silence"],
        background_cantrips: [],
        background_spells: [],
      },
  ...
  },
  {
    ...
    choices: {
      ...
      background: "Hermit",
      ability_scores_method: "standard_array",
      ability_scores: { Strength: 8, Dexterity: 13, Constitution: 14, Intelligence: 12, Wisdom: 15, Charisma: 10 },
      background_bonuses: { Wisdom: 2, Constitution: 1 },
      skill_choices: ["Nature", "Perception"],
      spell_selections: {
        cantrips: ["Druidcraft", "Shillelagh"],
        spells: ["Entangle", "Faerie Fire", "Cure Wounds", "Goodberry", "Barkskin", "Enhance Ability"],
        background_cantrips: [],
        background_spells: [],
      },
      languages: ["Sylvan", "Gnomish"],
      equipment_selections: { class_equipment: "option_a", background_equipment: "option_a" },
    },
  },
  {
  ...
  },
  {
    ...
    choices: {
      ...
      background: "Hermit",
      ability_scores_method: "standard_array",
      ability_scores: { Strength: 12, Dexterity: 15, Constitution: 13, Intelligence: 8, Wisdom: 14, Charisma: 10 },
  ...
  },
  {
    ...
    choices: {
      ...
      classes: [{ class_name: "Paladin", level: 3, subclass: "Oath of Vengeance" }],
      class: "Paladin",
      level: 3,
      subclass: "Oath of Vengeance",
      species: "Tiefling",
      ...
      background: "Soldier",
      ability_scores_method: "standard_array",
      ability_scores: { Strength: 15, Dexterity: 10, Constitution: 13, Intelligence: 8, Wisdom: 12, Charisma: 14 },
      background_bonuses: { Strength: 2, Charisma: 1 },
      skill_choices: ["Athletics", "Persuasion"],
      fighting_style: "Dueling",
      spell_selections: {
        cantrips: [],
        spells: ["Bless", "Divine Smite", "Detect Evil and Good", "Branding Smite", "Find Steed"],
        background_cantrips: [],
        background_spells: [],
      },
      languages: ["Celestial", "Elvish"],
  ...
  },
  {
    ...
    choices: {
      ...
      spell_selections: {
        cantrips: [],
        spells: ["Ensnaring Strike", "Fog Cloud", "Goodberry", "Barkskin", "Darkvision"],
        background_cantrips: [],
        background_spells: [],
      },
  ...
  },
  {
    ...
    choices: {
      ...
      background: "Criminal",
      ability_scores_method: "standard_array",
      ability_scores: { Strength: 8, Dexterity: 15, Constitution: 13, Intelligence: 14, Wisdom: 10, Charisma: 12 },
  ...
  },
  {
    ...
    choices: {
      ...
      classes: [{ class_name: "Sorcerer", level: 3, subclass: "Draconic Sorcery" }],
      class: "Sorcerer",
      level: 3,
      subclass: "Draconic Sorcery",
      species: "Aasimar",
      ...
      spell_selections: {
        ...
        spells: ["Chromatic Orb", "Burning Hands", "False Life", "Dragon's Breath", "Blur"],
        background_cantrips: [],
        background_spells: [],
      },
  ...
  },
  {
    ...
    choices: {
      ...
      ability_scores_method: "standard_array",
      ability_scores: { Strength: 10, Dexterity: 13, Constitution: 14, Intelligence: 8, Wisdom: 12, Charisma: 15 },
      background_bonuses: { Charisma: 2, Constitution: 1 },
      skill_choices: ["Intimidation", "Arcana"],
      spell_selections: {
        cantrips: ["Eldritch Blast", "Minor Illusion", "Mage Hand"],
        spells: ["Armor of Agathys", "Hellish Rebuke", "Hex", "Darkness", "Hold Person"],
        background_cantrips: [],
        background_spells: [],
      },
  ...
  },
  {
    ...
    choices: {
      ...
      background: "Scribe",
      ability_scores_method: "standard_array",
      ability_scores: { Strength: 8, Dexterity: 13, Constitution: 14, Intelligence: 15, Wisdom: 12, Charisma: 10 },
      background_bonuses: { Intelligence: 2, Constitution: 1 },
      skill_choices: ["Arcana", "History"],
      spell_selections: {
        cantrips: ["Fire Bolt", "Acid Splash", "Mage Hand"],
        spells: ["Burning Hands", "Chromatic Orb", "Detect Magic", "Alarm", "Blindness/Deafness", "Cloud of Daggers"],
        background_cantrips: [],
        background_spells: [],
      },
      languages: ["Elvish", "Draconic"],
